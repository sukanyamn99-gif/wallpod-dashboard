    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          เงินเข้า: ทุกรายการที่บันทึกว่าได้รับเงินแล้วตั้งแต่วันที่สร้างบัญชีนี้ ไม่ว่าจะออกใบเสร็จในระบบหรือคีย์เข้าตรง
          — เงินออก: ใบสำคัญจ่ายที่โอนเงินทุกใบตั้งแต่วันที่สร้างบัญชีนี้ (ไม่ดูว่าโอนเข้าบัญชีปลายทางใด)
        </p>
      </div>
