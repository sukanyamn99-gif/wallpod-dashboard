...
export async function GET() {
  ...
  const rows = allRows
    ...
    .map((p) => {
      ...
      row["กำไร"] = p.profit ?? "";
      row["เลขที่ใบวางบิล (งวด 1)"] = p.billingNoteNo1 ?? "";
      row["วันที่ออกใบวางบิล (งวด 1)"] = p.billingNoteDate1 ?? "";
      ...
      row["เลขที่ใบวางบิล (งวด 2)"] = p.billingNoteNo2 ?? "";
      row["วันที่ออกใบวางบิล (งวด 2)"] = p.billingNoteDate2 ?? "";
      ...
      row["เลขที่ใบวางบิล (งวด 3)"] = p.billingNoteNo3 ?? "";
      row["วันที่ออกใบวางบิล (งวด 3)"] = p.billingNoteDate3 ?? "";
