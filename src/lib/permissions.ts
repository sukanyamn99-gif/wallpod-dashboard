...
const PAGE_ACCESS: Record<string, PermissionTier[]> = {
  ...
  "/dashboard/stock-product/report": ["admin", "staff", "sale"],
  "/dashboard/inventory/alerts": ["admin", "staff", "sale"],
  "/dashboard/project-sales": ["admin", "staff"],
  "/dashboard/product-categories": ["admin", "staff"],
  "/dashboard/stock-requisition": ["admin", "staff"],
  "/dashboard/stock-requisition/report": ["admin", "staff"],
  "/dashboard/stock-movement": ["admin", "staff"],
  "/dashboard/inventory/report": ["admin", "staff"],
  "/dashboard/goods-receipt": ["admin", "staff"],
  "/dashboard/goods-receipt/report": ["admin", "staff"],
