...
const HEADER_COLUMNS =
  "id, doc_no, doc_type, customer_id, doc_date, credit_days, due_date, discount_amount, wht_percent, retention_percent, note, created_by, created_at, customers(name), sales_reps(name)";
